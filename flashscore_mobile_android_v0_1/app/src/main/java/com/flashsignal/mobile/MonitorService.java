...
public class MonitorService extends Service {
    ...
    private static final long STATS_RESCAN_MS = 10_000L;
    private static final long WORKER_TIMEOUT_MS = 25_000L;
    private static final long MONITOR_RELOAD_MS = 60_000L;
    ...
    private void createWebViews() {
        ...
        monitorWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                main.postDelayed(() -> injectMonitorScript(view), 1000L);
            }
        });
    ...
    private void startNextWorker() {
        if (currentWorkerId != null || workerWebView == null || !StateStore.isEnabled(this)) return;
    ...
    private String monitorStatus() {
        ...
        if (lastSnapshotAt == 0L) return "Monitor hazırlanıyor…";
        long sec = Math.max(0, (System.currentTimeMillis() - lastSnapshotAt) / 1000L);
